...
int min_pwB = 935; //default is 544
int max_pwB = 1935; // default is 2400   this pwm range is about 0 to 180 we 
...
void loop() {
  ...
  for (angle = max_pwB; angle >= 1435; angle -= 1) { //offset is about 3 deg for servo1, so 90 deg is around 1480 us
